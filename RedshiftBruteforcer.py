...
host='test-redshift-cluster.cxj2rpawsz0p.us-east-1.redshift.amazonaws.com'
# users_file='users.txt'
users_filename='redshift_users_8_len_short.txt'
passwords_filename='redshift_passwords_8_len_short.txt'
